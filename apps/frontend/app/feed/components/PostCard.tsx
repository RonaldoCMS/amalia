...
import { PostItem, ReportTargetType } from '@amalia/shared'
  ...
  return (
    <div className="border border-zinc-800 rounded-xl bg-zinc-900/50 overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4 pb-0">
        ...
        {!isOwner && (
          <ReportButton targetType={ReportTargetType.Post} targetId={post.id} reportedUserId={post.authorId} />
        )}
      </div>
